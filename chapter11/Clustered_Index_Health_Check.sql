...
When Sum(Case when state_description = 'COMPRESSED' and total_rows < 1048576 then 1 else 0 end ) > 0 then 'Many sub optimal segments found. Recompress the table using ALTER TABLE <table name> rebuild or reload the table using CTAS' 
